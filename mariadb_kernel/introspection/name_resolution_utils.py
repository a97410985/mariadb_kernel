...
def get_type_of_name_token_by_match_rule(
    token: TranslatedLexerTokenInfoWithMatchRule, rule_num: int, match_index: int
):
    if token["token_str"] in [
        "FCOUNT",
        "FCOUNT",
        "FSUBSTRING",
        "FDATE_ADD",
    ...
    name_resolution_with_match_index = {
        "46": {"0": "column", "2": "table"},
        "129": {"0": "table", "2": "column"},
        "131": {"2": "table", "4": "column"},
        "139": {"4": "database", "6": "table"},
        "142": {"4": "database", "6": "table"},
        "143": {"4": "database", "6": "table"},
        "223": {"0": "table", "2": "column"},
    }
